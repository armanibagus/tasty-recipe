...
onMounted(() => {
  if (props.isEdit) {
    let recipe = store.state.recipe.recipeDetail;

    recipeData.imageLink   = recipe.imageLink;
    recipeData.name        = recipe.name;
    recipeData.description = recipe.description;
    recipeData.category    = recipe.category;
    recipeData.prepTime    = recipe.prepTime;
    recipeData.cookTime    = recipe.cookTime;
    recipeData.totalTime   = recipe.totalTime;
    recipeData.ingredients = recipe.ingredients;
    recipeData.directions  = recipe.directions;
      ...
      <div>
        ...
        <div>
          ...
          <div class="mb-3">
            ...
            <div>
              <img :src="recipeData.imageLink" :alt="recipeData.name" class="image w-50">
            </div>
          </div>
          <!-- Image End -->
